...
function renderAjustesSocios() {
  ...
  if (esAdmin) $("#input-caja-local-monto").value = cajaLocalMonto ? formatMoneyValue(cajaLocalMonto) : "";
...
async function guardarCajaLocal() {
  const monto = parseMoneyInput($("#input-caja-local-monto").value);
